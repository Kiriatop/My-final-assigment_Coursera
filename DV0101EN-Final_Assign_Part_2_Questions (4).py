...
@app.callback(
    ...
    Input(component_id='dropdown-staristics',component_property='value')])
...
#Plot 2 Calculate the average number of vehicles sold by vehicle type       
    #create relev    # use groupby to ant data for plotting
...
# Plot 3 Pie chart for total expenditure share by vehicle type during recessions
        # use groupby to create relevant data for plotting
        exp_rec = recession_data.groupby('Vechicle_Type')['Advertising_Expenditure'].sum()
        R_chart3 = dcc.Graph(
        ...
        exp_rec = recession_data.groupby('Vechicle_Type','unemployment_rate' )['Automobile_Sales'].sum()
        R_chart4 = dcc.Graph(
...
# TASK 2.6: Create and display graphs for Yearly Report Statistics
 # Yearly Statistic Report Plots                             
    elif (input_year and selected_statistics=='Yearly Statisticks') :
...
#plot 1 Yearly Automobile sales using line chart for the whole period.
        ...
        Y_chart1 = dcc.Graph(figure=px.line(yas, x = 'Year', y = 'Automobile_Sales', title = 'Sales during years'))
            
# Plot 2 Total Monthly Automobile sales using line chart.
        mas = data.groupby('Month')['Automobile_Sales'].sum().reset_index()
        Y_chart2 = dcc.Graph(figure = px.bar(mas, x = 'Month', y = 'Automobile_Sales', title = 'Total Monthly Automobile sales '))
